...
//
//        );
//        Long idIndex = cursor.getColumnIndex(ProductContract.ProductEntry.COLUMN_ID);
//        Long nameIndex = cursor.getColumnIndex(ProductContract.ProductEntry.COLUMN_NAME);
//        Long descriptionIndex = cursor.getColumnIndex(ProductContract.ProductEntry.COLUMN_DESCRIPTION);
//        Long priceIndex = cursor.getColumnIndex(ProductContract.ProductEntry.COLUMN_PRICE);
//        Long categoryIndex = cursor.getColumnIndex(ProductContract.ProductEntry.COLUMN_CATEGORY);
//        Long availableQuantityIndex = cursor.getColumnIndex(ProductContract.ProductEntry.COLUMN_AVAILABLE_QUANTITY);
//        cursor.moveToFirst();
...
//                Long colorCount = new Random().nextInt(8) + 1;
//                while (colorCount > 0) {
...
//            List<Product> products = getAllProducts();
//            for (Product product : products) {
//                Long sizeCount = new Random().nextInt(5) + 1;
//                while (sizeCount > 0) {
...
//            List<Product> products = getAllProducts();
//            for (Product product : products) {
//                Long imageCount = new Random().nextInt(5) + 1;
//                while (imageCount > 0) {
//                    Long image = generateImageByCategory(product.getCategory());
...
//        Long index = random.nextInt(sizes.length);
//
...
//    }
//
//    private Long hexColorToInteger(String hexColor) {
...
//        Long red = random.nextInt(256);
//        Long green = random.nextInt(256);
//        Long blue = random.nextInt(256);
//
//        // Convert RGB to hex
...
//                Long index = random.nextInt(images.length);
//
//                image = images[index];
//
//                break;
...
//        cursor.moveToFirst();
//        while (!cursor.isAfterLast()) {
//            Long productId = cursor.getInt(idIndex);
//            String productName = cursor.getString(nameIndex);
//            String productDescription = cursor.getString(descriptionIndex);
//            Long productPrice = cursor.getInt(priceIndex);
//            String productCategory = cursor.getString(categoryIndex);
//            Long productQuantity = cursor.getInt(availableQuantityIndex);
//
//            List<ProductColor> colors = getColorsForProduct(productId);
//            List<ProductSize> sizes = getSizesForProduct(productId);
//            List<ProductImage> images = getImagesForProduct(productId);
...
//        items.add(new CategoryItem("Áo khoác", ""));
//        items.add(new CategoryItem("Hoodie", ""));
//        items.add(new CategoryItem("Giày", ""));
//        items.add(new CategoryItem("Đồng hồ", ""));
//        items.add(new CategoryItem("Bóp", ""));
//        items.add(new CategoryItem("Túi xách", ""));
//        return items;
//    }
//
...
//    }
//
//    private List<ProductColor> getColorsForProduct(Long productId) {
...
//
//        Long colorHexIndex = colorCursor.getColumnIndex(ProductContract.ColorEntry.COLUMN_HEX_COLOR);
//
...
//    }
//
//    private List<ProductSize> getSizesForProduct(Long productId) {
...
//
//        Long sizeNameIndex = sizeCursor.getColumnIndex(ProductContract.SizeEntry.COLUMN_SIZE);
//
...
//
//        Long imageIdIndex = imageCursor.getColumnIndex(ProductContract.ImageEntry.COLUMN_IMAGE);
//
//        imageCursor.moveToFirst();
//        while (!imageCursor.isAfterLast()) {
//            Long imageId = imageCursor.getInt(imageIdIndex);
